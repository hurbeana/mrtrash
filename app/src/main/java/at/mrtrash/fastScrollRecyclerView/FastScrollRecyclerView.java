package at.mrtrash.fastScrollRecyclerView;
...
public class FastScrollRecyclerView extends RecyclerView {
    ...
    private void setupThings() {
        //create az text data
        Set<String> sectionSet = ((at.mrtrash.fastScrollRecyclerView.FastScrollRecyclerViewInterface)getAdapter()).getMapIndex().keySet();
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN: {
                if (x < sx - scaledWidth || y < sy || y > (sy + scaledHeight*sections.length))
                    ...
                    if( ((at.mrtrash.fastScrollRecyclerView.FastScrollRecyclerViewInterface)getAdapter()).getMapIndex().containsKey(section.toUpperCase()) )
                        positionInData = ((at.mrtrash.fastScrollRecyclerView.FastScrollRecyclerViewInterface)getAdapter()).getMapIndex().get(section.toUpperCase());
